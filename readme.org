...
This package provides [[https://notmuchmail.org/][notmuch]] queries in emacs using [[https://github.com/minad/consult][consult]].  The
file ~consult-notmuch.el~ is automatically generated from this org
document, and has the typical sectioning of an emacs package:
