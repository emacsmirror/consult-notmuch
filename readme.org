...
This package provides [[https://notmuchmail.org/][notmuch]] queries in emacs using [[https://github.com/minad/consult][consult]].  It's
code is tangled from this document (see [[*consult-notmuch.el][this section]] for its
template).
